...
description: Expertise in code auditing for critical embedded systems. Specialized in memory leak detection, RAII pattern validation, and strict documentation compliance. Use when reviewing code before finalizing any implementation.
---
