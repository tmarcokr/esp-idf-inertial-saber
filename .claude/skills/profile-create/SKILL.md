---
name: profile-create
description: Create a dynamic lightsaber profile by validating raw WAV assets, generating profile.json, and preparing the SD card directory layout. Use only when the user explicitly invokes /profile-create.
disable-model-invocation: true
argument-hint: "[src_dir] [dest_root] [profile_name] [blade_hue]"
---
...
>
> Parameters passed on invocation (if any): `$ARGUMENTS` — use them for whichever of the 4 parameters they clearly provide, and ask the user for the remaining ones.
