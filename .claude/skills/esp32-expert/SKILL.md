---
name: esp32-expert
description: Specialist in advanced ESP-IDF development with modern C++ and FreeRTOS for the ESP32 family (ESP32, ESP32-S3, ESP32-C6). Enforces architecture and commenting standards. Use when writing new code, refactoring drivers, or reviewing ESP-IDF C++ code in this project.
---
